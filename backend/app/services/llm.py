...
性格重みをシステムプロンプトに埋め込み、トーン・丁寧さ・冗長さを調整する
"""
import re
...
ユーザーの性格プロフィールに基づいて、応答スタイルを調整してください。

## ユーザーの性格プロフィール（0.0〜1.0）
...
- 神経症傾向: {neuroticism:.2f}（高い→感情的配慮、低い→淡々と）
...
- 神経症傾向が0.7以上の場合：感情に寄り添い、励ます言葉を添える
- 神経症傾向が0.3未満の場合：感情より事実・論理を重視する
